...
{
    if (($product['stock_status'] ?? '') === 'sold_out' || (int) ($product['stock'] ?? 0) <= 0) {
        return 'Sold Out';
    }
...
?>
<section class="card">
  <div class="card-head"><h3>Daftar Produk</h3><a class="primary-btn" href="product-form.php">Tambah Produk</a></div>
  <div class="table-wrap">
    <table>
      <thead><tr><th>Produk</th><th>Kategori</th><th>Harga</th><th>Stok</th><th>Status</th><th>Aktif</th><th>Aksi</th></tr></thead>
      <tbody>
